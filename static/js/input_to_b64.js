 ...
 */
function input_to_b64(input_field_ids, place_for_new_inputs) {
    ...
    for (var input_field_id = 0; input_field_id < input_field_ids.length; input_field_id++) {
        var input_element = document.getElementById(input_field_ids[input_field_id]);
